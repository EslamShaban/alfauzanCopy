...
@section('content')
	<div class = "panel panel-flat">
		<div class = "panel-heading">
			<h5 class = "panel-title">اهداف الحجز</h5>
								...
								<ul class = "dropdown-menu dropdown-menu-right">
									...
									<li>
										<a href = "#" data-toggle = "modal" data-target = "#exampleModal2"
										   class = "openEditmodal" data-id = "{{$reason->id}}"
										   data-name_ar = "{{$reason->name_ar}}" data-name_en = "{{$reason->name_en}}">
									...
									<!-- delete button -->
									<form action = "{{route('delete_reason')}}" method = "POST">
										{{csrf_field()}}
			...
			<div class = "modal-dialog" role = "document">
				<div class = "modal-content">
					<div class = "modal-header">
						<h5 class = "modal-title" id = "exampleModalLabel">أضافة هدف للحجز </h5>
					</div>
					<div class = "modal-body">
						<div class = "row">
							<form action = "{{route('add_reason')}}" method = "POST">
								{{csrf_field()}}
		...
		<div class = "modal fade" id = "exampleModal2" tabindex = "-1" role = "dialog"
			...
			<div class = "modal-dialog" role = "document">
				<div class = "modal-content">
					<div class = "modal-header">
						<h5 class = "modal-title" id = "exampleModalLabel"> تعديل هدف الحجز : <span
								   class = "userName"></span></h5>
					</div>
					<div class = "modal-body">
						<form action = "{{route('update_reason')}}" method = "post">
