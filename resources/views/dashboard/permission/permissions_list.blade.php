...
@section('content')
    ...
    <div class = "panel panel-flat">
        ...
        <div class = "panel-body">
            <div class = "row">
                <div class = "col-xs-3">
                    <a href = "{{route('addpermissionspage')}}"
                       class = "btn bg-blue btn-block btn-float btn-float-lg openAddModal" type = "button"><i
                            class = "icon-plus3"></i> <span>اضافة صلاحيه</span></a>
                </div>
                <div class = "col-xs-3">
                    <button class = "btn bg-purple-300 btn-block btn-float btn-float-lg" type = "button"><i
                            class = "icon-list-numbered"></i> <span>عدد الصلاحيات : {{count($roles)}} </span></button>
                </div>
                <div class = "col-xs-3">
                    <button class = "btn bg-teal-400 btn-block btn-float btn-float-lg reload" type = "button"><i
                            class = "icon-reload-alt"></i> <span>تحديث الصفحه</span></button>
                </div>
                <div class = "col-xs-3">
                        ...
                        <ul class = "icons-list">
                            <li class = "dropdown">
                                ...
                                <ul class = "dropdown-menu dropdown-menu-right">
                                    ...
                                    {{--disable delete option for user and admin--}}
                                    @if(!($r->id == 1 || $r->id==2))
