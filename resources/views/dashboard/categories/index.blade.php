								...
								<div class = "row">
									...
									<div class = "col-sm-12" style = "margin-top: 10px">
										...
										<select name = "type"  class = "form-control"
											...
											<option selected hidden disabled>--إختر النوع --</option>
							...
							<div class = "row">
								...
								<div class = "col-sm-12" style = "margin-top: 10px">
									...
									<select name = "edit_type"  class = "form-control"
									        style = "margin-bottom: 5px" required>
										<option  hidden disabled>--إختر النوع --</option>
										<option id = "no_offer" value = "0">عادى</option>
										<option id = "offer" value = "1">مميز</option>
									</select>
								</div>
