<div class = "navbar navbar-inverse">
	<div class = "navbar-header">
		<a class = "navbar-brand" href = "https://www.aait.sa">مؤسسة ثروة</a>
			...
			<li class = "dropdown">
				...
				<div class = "dropdown-menu dropdown-content width-350" style = "width: 250px">
							...
							<li class = "media">
								<div class = "media-left">
									...
									<div class = "media-body">
										@if($n->ads_id)
											<a href = "{{route('ad_rooms',$n->ads_id)}}" class = "media-heading">
												<span class = "text-semibold">{{$n->sender->name}}</span>
										@else
					...
					<div class = "dropdown-content-footer">
						<a href = "{{route('inbox')}}" data-popup = "tooltip" title = "All messages"><i
								   class = "icon-menu display-block"></i>مشاهدة جميع الرسائل</a>
					</div>
				</div>
			</li>
		</ul>
