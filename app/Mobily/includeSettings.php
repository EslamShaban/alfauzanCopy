...
//لإختيار الدالة المناسبة  حسب خصائص موقعك	
    ...
    include_once ("function/checkSendPorts.php");
...

{
    ...
    include_once ("function/fsockopen.php");
...

{
    ...
    include_once ("function/fopen.php");
...

{
    ...
    include_once ("function/filegetcontents.php");
...
//لطباعة القيمة الناتجه من بوابة الإرسال على شكل نص
    ...
    include_once ("function/functionPrintResult.php");



//دالة تشفير نص الرساله إلى الترميز UNICODE

    include_once ("function/functionUnicode.php");
