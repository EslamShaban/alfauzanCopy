...
//            $social -> name = $request -> edit_site_name;
        ...
        public function SiteSetting( Request $request )
        {
            ...
            $this -> validate( $request, [
                ...
                'phone'     => 'nullable|min:2|max:190',
                'logo'      => 'nullable|image',
            ] );

            $SiteSetting               = SiteSetting ::first();
            $SiteSetting -> site_name  = $request -> site_name;
            $SiteSetting -> site_phone = $request -> phone;
        ...
        public function SEO( Request $request )
        {
            ...
            $SiteSetting -> site_description_en = $request -> site_description_en;
            $SiteSetting -> site_copyrigth      = $request -> site_copyrigth;
            $SiteSetting -> site_copyrigth_en   = $request -> site_copyrigth_en;
            $SiteSetting -> save();
            Session ::flash( 'success', 'تم حفظ التعديلات' );
            return back();
        }
